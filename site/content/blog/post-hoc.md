...
バラツキを指標化した値が皆さんご存じ分散(√を取れば標準偏差)です。分散を基準に評価する分析法なのでANOVA(分散分析、analysis of variance)と言います。見たいグループに対して、総平均との差を取ってそれぞれ2乗して足し合わせた値で判断します。これをSS(平方和、sum of squares/squared sum)と言います。
