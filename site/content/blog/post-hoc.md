...
もし条件による差が全くなければ、全て同じ値、すなわち平均μになるはずです(Y=μ)。また、データ内にバラツキがあってもそれが全て条件による影響Ａだとしたら、各条件内では全く同じ値を取っているはずです(Y=A+μ)。でも現実世界では、大抵はデータの中には効果Ａによっても説明できない誤差があります。これを残差εという呼びます(この場合は主に個人差ってやつです)。
