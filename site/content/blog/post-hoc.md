...
> ※統計を学ぶ時、教科書上ではだいたい正規分布→χ²分布→F分布→T分布の順番で載っていますが、分析方法を学ぶ順番がだいたいT検定→ANOVA、となってるので皆チンプンカンプンになります。ANOVAを学ぶうえでの最初の感動はやはり教科書通りに一連の流れでこれらの分布を理解することなので興味ある方は是非勉強してみてください。
