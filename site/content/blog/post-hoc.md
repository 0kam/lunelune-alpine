...
これでモデルに依存しない効果量になりました。ちなみにチュパカブラの例ではモデルの右辺にはそもそも効果が一つしかないので、η²=偏η²=0.58になります。どのみち大きいには変わらないので主効果は無視できないですね。
...
例えば、有意水準をα=5%として、チュパカブラの例で飼い主の総当たり比較を行うと₃C₂=3回t-testを行うことになります。
